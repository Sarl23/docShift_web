...
export default function ManagementPage() {
    ...
    return <div className="bg-background p-12">
        <h1 className="text-3xl font-bold mb-8">Asignacion de turnos</h1>
        <div className="flex items-start justify-between gap-8">
            <div className="flex flex-col space-y-4">
                {users?.map((user, index) => (
                    <Card key={index} className={`w-80 h-[7rem] cursor-pointer transition-all ${selectedUser?.userId === user.userId
                        ...
                        <CardContent>
                            <div className="flex items-center gap-2.5">
                                <img src="/src/assets/sarl-sticker.png" alt="Doctor" className="w-24 h-24 rounded-full" />
                                <div className="ml-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="flex items-center justify-between gap-2.5">
                            <img src="/src/assets/sarl-sticker.png" alt="Doctor" className="w-48 h-48 rounded-full" />
                            <div>
